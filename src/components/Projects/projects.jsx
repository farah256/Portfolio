...
const Projects = () => {
    ...
    const projectsData = t.projects.projectsData.map((project, index) => ({
        ...
        tags: [
            ...
            ["React", "Spring Boot", "MySQL", "Dashboard", "Website"],
            ["C", "C++"],
                ...
                <div className="flex flex-col lg:flex-row">
                    ...
                    <div className="lg:w-2/5 p-8 bg-black/20">
                        ...
                        >
                            ...
                            {/* Action Buttons */}
                            <div className="flex flex-col mb-5 mt-20 sm:flex-row gap-4">
                                <a
                            ...
                            <a
                                    ...
                                    className="flex items-center justify-center gap-2 px-6 py-3 bg-transparent border-2 border-white text-white rounded-lg font-semibold hover:bg-white hover:text-gray-900 transition-all duration-300"
                                >
